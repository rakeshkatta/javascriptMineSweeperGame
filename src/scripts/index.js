...
// Game which take input to construct the grid canvas 
...
//draw game taking input width and heoght and fill the rectangle
...
// mine class where object get initialzed 
class Mine {
    constructor(x, y) {
        this.x = x;
        this.y = y;
